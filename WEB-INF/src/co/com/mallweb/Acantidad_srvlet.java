...
@WebServlet(name = "Acantidad_srvlet", urlPatterns = {"/actualizarC"})
public class Acantidad_srvlet extends HttpServlet{
        ...
        try {
        	String nombre = request.getParameter("in_nombreA");
 	    	...
 	    	if(!ls.isEmpty()){
 	    		...
 	    		String cantidad = request.getParameter("newcantidad");
 	 	        
 	 	    	Map<String, Object> fields2 = new HashMap<String, Object>();
 	 	    
 	 	    	fields2.put("precio", cantidad);
